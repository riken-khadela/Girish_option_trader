...
def strategyone():
    while True:
        ...
        sell_ce_lot = all_st_data.sell_ce_lot
        sell_pe_lot = all_st_data.sell_pe_lot
        ...
        ce_buy_lot = all_st_data.ce_buy_lot
        pe_buy_lot = all_st_data.pe_buy_lot
        nw_ce_buy_lot = all_st_data.nw_ce_buy_lot
        nw_pe_buy_lot = all_st_data.nw_pe_buy_lot
